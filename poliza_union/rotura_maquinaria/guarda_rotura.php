...
$numrot = $con ->query("SELECT MAX(id_rotmaq) as idrotura FROM rot_maq_bu");
		          $num_rotura = $numrot -> fetch_assoc();
                  $ids= $num_rotura['idrotura']+1;
$prefijo = 'RMLP';
...
$ins = $con -> query("INSERT INTO `rot_maq_bu`(`codigo`, `id_rotmaq`, `nro_poliza`, `cod_cliente`,`tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('','$ids','$nro_poliza','$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
