<?php 
    ...
    $consulta = mysql_query("SELECT * FROM rot_maq_bu WHERE id_rot_maq_bu='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>PÓLIZA DE SEGURO CONTRA ROTURA DE MAQUINARIA</strong></td>
        </tr>
        <tr>
