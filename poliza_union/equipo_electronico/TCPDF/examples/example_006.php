<?php 
    ...
    $consulta = mysql_query("SELECT * FROM equi_elec_bu WHERE id_equielec_bu='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>PÓLIZA DE TODO RIEGO EQUIPO ELECTRÓNICO</strong></td>
        </tr>
        <tr>
