...
$numele = $con ->query("SELECT MAX(id_equielec) as idelec FROM equi_elec_bu");
		          $num_elec = $numele -> fetch_assoc();
                  $ids= $num_elec['idelec']+1;
$prefijo = 'EELP';
...
$ins = $con -> query("INSERT INTO `equi_elec_bu`(`codigo`, `id_equielec`, `nro_poliza`, `cod_cliente`, `tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('','$ids','$nro_poliza','$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
