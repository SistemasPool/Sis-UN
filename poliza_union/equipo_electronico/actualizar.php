...
$sel = $con -> query("SELECT * FROM equi_elec_bu WHERE id_equielec_bu='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>PÓLIZA DE SEGURO CONTRA TODO RIESGO EQUIPO ELECTRÓNICO</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_equielec_bu']; ?>">
          <br>
          <div class="col-md-12">
