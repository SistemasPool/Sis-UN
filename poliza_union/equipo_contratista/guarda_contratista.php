...
$numcont = $con ->query("SELECT MAX(id_equicont) as idcontra FROM equi_cont_bu");
		          $num_contra = $numcont -> fetch_assoc();
                  $ids= $num_contra['idcontra']+1;
$prefijo = 'ECLP';
...
$ins = $con -> query("INSERT INTO `equi_cont_bu`(`codigo`, `id_equicont`, `nro_poliza`, `cod_cliente`,`tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('','$ids','$nro_poliza', '$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
