<?php 
    ...
    $consulta = mysql_query("SELECT * FROM equi_cont_bu WHERE id_equi_cont_bu='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>PÓLIZA DE SEGURO TODO RIESGO EQUIPO CONTRATISTA</strong></td>
        </tr>
        <tr>
