...
$sel = $con -> query("SELECT * FROM equi_cont_bu WHERE id_equi_cont_bu='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>PÓLIZA DE TODO RIESGO EQUIPO CONTRATISTA</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_equi_cont_bu']; ?>">
          <br>
          <div class="col-md-12">
