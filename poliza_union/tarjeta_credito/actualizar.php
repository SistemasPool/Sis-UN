...
$sel = $con -> query("SELECT * FROM tarjeta_credito WHERE id_tarjeta_credito='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>SEGURO DE PROTECCIÓN TARJETAS - CRÉDITO</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_tarjeta_credito']; ?>">
          <br>
          <div class="col-md-12">
