<?php 
    ...
    $consulta = mysql_query("SELECT * FROM tarjeta_credito WHERE id_tarjeta_credito='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>SEGURO DE PROTECCIÓN TARJETAS - CRÉDITO</strong></td>
        </tr>
        <tr>
