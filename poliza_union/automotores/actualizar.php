...
$sel = $con -> query("SELECT * FROM automotores_bu WHERE id_automotores='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>PÓLIZA DE SEGUROS DE AUTOMOTORES</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_automotores']; ?>">
          <br>
          <div class="col-md-12">
