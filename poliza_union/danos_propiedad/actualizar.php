...
$sel = $con -> query("SELECT * FROM danos_prop_bu WHERE id_danprop='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>PÓLIZA DE SEGURO CONTRA TODO RIESGO DE DAÑOS A LA PROPIEDAD</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_danprop']; ?>">
          <br>
          <div class="col-md-12">
