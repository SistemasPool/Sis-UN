<?php 
    ...
    $consulta = mysql_query("SELECT * FROM danos_prop_bu WHERE id_dan_prop='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>PÓLIZA DE SEGURO CONTRA TODO RIESGO DE DAÑOS A LA PROPIEDAD</strong></td>
        </tr>
        <tr>
