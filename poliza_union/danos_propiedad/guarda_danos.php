...
$numdan = $con ->query("SELECT MAX(id_danprop) as iddanpro FROM danos_prop_bu");
		          $num_danpro = $numdan -> fetch_assoc();
                  $ids= $num_danpro['iddanpro']+1;
$prefijo = 'DPLP';
...
$ins = $con -> query("INSERT INTO `danos_prop_bu`(`id_dan_prop`, `codigo`, `id_danprop`, `nro_poliza`, `cod_cliente`, `tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('', '','$ids','$nro_poliza','$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
