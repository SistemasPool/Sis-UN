      ...
      <div class="starter-template">
        ...
        <thead>
            <tr><!-- <th>Nro Póliza</th> -->
                ...
                <th>
                    <a href="debito.php"><button class="btn btn-primary btn-xs"><i class="fas fa-plus"></i></button></a></th>
            </tr>
        </thead>
        <tfoot>
            <tr> <!-- <th>Nro Póliza</th> -->
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT * FROM tarjeta_debito WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['nro_poliza'];?></td>
		 	...
		 	<td><?php echo $fila['tomador']; ?></td>
		 	<td><?php echo $fila['distrito']; ?></td>
		 	<td><?php echo $fila['f_registro']; ?></td>
		 	<td>
                <a href="actualizar.php?id=<?php echo $fila['id_tarjeta_debito'] ?>"><button class="btn btn-success btn-xs" type="submit"><i class="fas fa-pencil-alt"></i></button></a>
                <a href="borrar.php?id=<?php echo $fila['id_tarjeta_debito'] ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-times"></i></button></a>
                <a href="TCPDF/examples/example_006.php?id=<?php echo $fila['id_tarjeta_debito'] ?>"><button class="btn btn-default btn-xs" type="submit"><i class="far fa-file-pdf"></i></button></a>
                <a href="ver_td.php?nro_poliza=<?php echo $fila['nro_poliza'] ?>&cod_cliente=<?php echo $fila['cod_cliente'] ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a></td>
		 </tr>
                  <?php } ?>
        </tbody>
    </table>
