<?php 
    ...
    $consulta = mysql_query("SELECT * FROM tarjeta_debito WHERE id_tarjeta_debito='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>SEGURO DE PROTECCIÓN TARJETAS - DÉBITO</strong></td>
        </tr>
        <tr>
