...
$numdeb = $con ->query("SELECT MAX(id_tardeb) as iddebito FROM tarjeta_debito");
		          $num_debito = $numdeb -> fetch_assoc();
                  $ids= $num_debito['iddebito']+1;
$prefijo = 'TDLP';
...
$ins = $con -> query("INSERT INTO `tarjeta_debito`(`codigo`, `id_tardeb`, `nro_poliza`, `cod_cliente`, `tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('','$ids','$nro_poliza','$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
