      ...
      <div class="starter-template">
        ...
        <thead>
            <tr><!-- <th>Nro Póliza</th> -->
                ...
                <th>
                    <a href="incendio.php"><button class="btn btn-primary btn-xs"><i class="fas fa-plus"></i></button></a></th>
            </tr>
        </thead>
        <tfoot>
            <tr> <!-- <th>Nro Póliza</th> -->
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT * FROM incencio_bu WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['nro_poliza'];?></td>
		 	...
		 	<td>
                <a href="actualizar.php?id=<?php echo $fila['id_incendio_bu'] ?>"><button class="btn btn-success btn-xs" type="submit"><i class="fas fa-pencil-alt"></i></button></a>
                <a href="borrar.php?id=<?php echo $fila['id_incendio_bu'] ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-times"></i></button></a>
                <a href="TCPDF/examples/example_006.php?id=<?php echo $fila['id_incendio_bu'] ?>"><button class="btn btn-default btn-xs" type="submit"><i class="far fa-file-pdf"></i></button></a></td>
		 </tr>
                  <?php } ?>
        </tbody>
    </table>
