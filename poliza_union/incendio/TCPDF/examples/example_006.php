<?php 
    ...
    $consulta = mysql_query("SELECT * FROM incencio_bu WHERE id_incendio_bu='$id'");
    $resultado = mysql_fetch_array($consulta);
    $html='<table align="center">
        <tr>
          <td style="font-size:9px;"><strong>PÓLIZA DE SEGURO CONTRA INCENDIO Y LÍNEAS ALIADAS</strong></td>
        </tr>
        <tr>
