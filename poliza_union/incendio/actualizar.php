...
$sel = $con -> query("SELECT * FROM incencio_bu WHERE id_incendio_bu='$id' ");
      ...
      <div class="container">
          <form action="update.php" method="post">
            ...
            <div class="col-md-12" style="text-align:center;">
                <h4>PÓLIZA DE SEGURO CONTRA INCENDIO Y LÍNEAS ALIADAS</h4>
            </div>
            <div class="col-md-12" style="text-align:center;">
          ...
          <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $fila['id_incendio_bu']; ?>">
          <br>
          <div class="col-md-12">
