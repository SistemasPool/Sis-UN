...
$numinc = $con ->query("SELECT MAX(id_incbu) as idincendio FROM incencio_bu");
		          $num_inc = $numinc -> fetch_assoc();
                  $ids= $num_inc['idincendio']+1;
$prefijo = 'INLP';
...
$ins = $con -> query("INSERT INTO `incencio_bu`(`codigo`, `id_incbu`, `nro_poliza`, `cod_cliente`,`tomador`, `asegurados`, `distrito`, `usuario`, `f_registro`) VALUES('','$ids','$nro_poliza','$cod_cliente','$tomador','$asegurados','$distrito','$usuario','$fecha_registro')");
