...
$sel = $con -> query("SELECT * FROM riesgo_cubierto_au_pol WHERE id_riecu='$id' ");
    ...
    <div class="container">
         <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR RIEGOS CUBIERTOS ::.</h6>
          </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Código de Cotización</label>
                                    <input type="text" class="form-control" id="cod_cotizacion" name="cod_cotizacion" value="<?php echo $fila['cod_cotizacion'] ?>" readonly>
                                  </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="porcentaje" name="porcentaje" value="<?php echo $fila['porcentaje'] ?>">
                              </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Estado</label>
                                <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $fila['estado'] ?>">
                              </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Franquicia</label>
                                <input type="text" class="form-control" id="franquicia" name="franquicia" value="<?php echo $fila['franquicia'] ?>">
                              </div>
                            </div>
                            <div class="col-md-6">
                                <br>
