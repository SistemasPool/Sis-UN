...
$sel = $con -> query("SELECT * FROM acc_perso_au_pol WHERE id_acc_pers='$id' ");
    ...
    <div class="container">
         ...
         <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR ACCIDENTES PERSONALES ::.</h6>
          </div>
        ...
        <input type="hidden" name="id" value="<?php echo $id ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $fila['cubre'] ?>">
                              </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
