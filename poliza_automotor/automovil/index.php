...
<nav class="navbar navbar navbar-default navbar-static-top marginBottom-0" role="navigation">
    ...
    <div class="container">
        ...
        <thead>
            <tr>
                ...
                <th><!-- <a href="include/registrar.php">
                    <button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-plus"></i></button></a> --></th>
            </tr>
        </thead>
        <tfoot>
            <tr>
      ...
      <td><?php echo $fila['distrito'] ?></td>
		 	<td>
               <!-- <a href="include/actualizar.php?id=<?php echo $fila['id_automovil'] ?>"><button class="btn btn-success btn-xs" type="submit" ><i class="fas fa-pencil-alt"></i></button></a>
                ...
                <a href="include/ver_automovil.php?id=<?php echo $fila['id_automovil'] ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a> 
                </td>
                <td>
              </td>
		 </tr>
