...
$sel = $con -> query("SELECT * FROM clientes_tomador WHERE id_cliente_tomador='$id' ");
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="calular" name="celular" value="<?php echo $fila['celular'] ?>">
                              </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
