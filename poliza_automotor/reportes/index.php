      ...
      <div class="starter-template">
        ...
        <tbody>
         ...
         <td>
                ...
                <a href="include/historial_siniestro.php?num_siniestro=<?php echo $fila['num_siniestro'] ?>"><button class="btn btn-default btn-xs" type="submit" ><i class="fas fa-file"></i></button></a>
                ...
                <a href="include/borrar.php?id=<?php echo $fila['id_automovil'] ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-times"></i></button></a>
                <a href="include/ver_siniestro.php?num_siniestro=<?php echo $fila['num_siniestro'] ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a>
                </td>
		 </tr>
                  <?php } ?>
        </tbody>
