...
$sel = $con -> query("SELECT * FROM clau_adic_au_pol WHERE id_clau_adic='$id' ");
...
<br><br>
    <div class="container">
          ...
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR CLAUSULAS ADICIONALES ::.</h6>
          </div>
