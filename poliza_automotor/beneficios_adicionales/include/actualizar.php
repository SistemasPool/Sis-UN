...
$sel = $con -> query("SELECT * FROM ben_adic_au_pol WHERE id_ben_au='$id' ");
...
<html lang="es">
  <head>
    ...
    <title>Beneficios Adicionales</title>
    ...
    <div class="container">
     <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR BENEFICIOS ADICIONALES ::.</h6>
          </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="cubre" name="cubre" value="<?php echo $fila['cubre'] ?>">
                              </div>
                            </div>
