...
$sel = $con -> query("SELECT * FROM respon_civil_auto_pol WHERE id_respciv='$id' ");
...
<br><br><br>
    <div class="container">
          ...
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR REPONSABILIDAD CIVIL ::.</h6>
          </div>
        ...
        <input type="hidden" name="id" value="<?php echo $id ?>">
                    <div class="container">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Cobertura</label>
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control" id="suma_asegurada" name="suma_asegurada" value="<?php echo $fila['suma_asegurada'] ?>">
                              </div>
                            </div>
                            <div class="col-md-5">
                            <div class="form-group">
