...
<nav class="navbar navbar navbar-default navbar-static-top marginBottom-0" role="navigation">
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <tbody>
                  <?php
		          $sel = $con ->query("SELECT * FROM anexo_automotor");
		          while ($fila = $sel -> fetch_assoc()) {
		          ?>
		 <tr>
		 	<td><?php echo $num_anexo= $fila['num_anexo'] ?></td>
		 	<td><?php echo $num_poliza = $fila['num_poliza'] ?></td>
		 	<td><?php echo $cod_cliente = $fila['cod_cliente'] ?></td>
            <td><?php echo $fila['placa'] ?></td>
            <td><?php echo $fila['tipo_prima'] ?></td>
            ...
            <?php
             ...
             ?>
             <td>
             <a href="../pdf/pdf_anexo.php?num_anexo=<?php echo $num_anexo;?>&cod_cliente=<?php echo $cod_cliente;?>&nro_poliza=<?php echo $num_poliza;?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fa fa-book"></i></button></a></td>
             <?php
             }else{
             ?>
         <td>
                ...
                <a href="include/actualizar.php?id=<?php echo $fila['id_automovil'] ?>"><button class="btn btn-warning btn-xs" type="submit" ><i class="fas fa-pencil-alt"></i></button></a>
                <a href="include/borrar.php?id=<?php echo $fila['id_automovil'] ?>"><button class="btn btn-default btn-xs" type="submit"><i class="fas fa-times"></i></button></a>
                <a href="../pdf/pdf_anexo.php?num_anexo=<?php echo $num_anexo;?>&cod_cliente=<?php echo $cod_cliente;?>&nro_poliza=<?php echo $num_poliza;?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fa fa-book"></i></button></a>
                </td>
             <?php } ?>
		 </tr>
                  <?php } ?>
