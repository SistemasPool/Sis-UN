...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.12/css/all.css">
  ...
  <body>
   <nav class="navbar navbar navbar-default navbar-static-top marginBottom-0" role="navigation">
      ...
      <br><br>
      <div class="container">
          <form action="guarda_anexo.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="condiciones" name="condiciones" maxlength="255">
          </div>
          <label for="exampleSelect1">Descripción:</label>
          <textarea id="txt_anexo" name="txt_anexo"></textarea>
        <br><br>
          <div class="row">
          <div class="col-md-12">
          ...
          <div class="col-md-3">
           <div class="form-group">
            <label for="exampleSelect1">Tipo de Prima</label>
            <select class="form-control" id="tipo_prima" name="tipo_prima">
              <option>Seleccione el tipo de prima</option>
