...
$sql = $con -> query("SELECT * FROM libro_ventas WHERE id_lv='$id'");
$row = $sql -> fetch_assoc();
...
$nombre_razon = $row['nombre_razon'];
    ...
    //$d = "2010-03-09";
    $fecha = strftime("%d de %B de %Y", strtotime($fecha_factura));
...
<table cellspacing="0" style="width: 100%;">
		...
		<tr>
           <td style="width:100%; font-size: 14px;">
			...
			<?php 
                ...
                //echo "<br> FECHA: ";
				echo "<p class='saltos'>Lugar y Fecha: La Paz, ".$fecha.'</p>';
                echo "<p class='saltos'>Señor(es): ";
				echo utf8_encode($nombre_razon).'</p>';
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        ...
        <tr style="height: 70px;">
            ...
            <td style="width: 60%; text-align: left"><?php echo utf8_encode($concepto); ?></td>
...
<div>
            ...
            <div style="text-align: right; width:10%; border:solid 1px; font-size:10px; display:inline;">TOTAL BS:</div>
            <div style="text-align: right; width:10%; border:solid 1px; font-size:10px; display:inline;"><?php echo number_format($monto,2); ?></div>
            </div>
<div class="container">
        <?php
        ...
        $contenido = $ci_nit."|".$monto."|".$num_factura."|".$numero_autorizacion."|".$fecha_factura."|".$codigo_control."|"; //Texto
