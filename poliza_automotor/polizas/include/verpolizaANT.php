    ...
    <hr style="background-color: #FFF100; height: 2px; border: 0;">
     <div class="container" style="font-size:12px;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">Prima Contado: <?php echo number_format($pritot= $automo['auto_cap_aseg']*$tasa_prima/100,2); ?></div>
            <div class="col-md-6">Prima Cr&eacute;dito: <?php echo number_format($pricre = ($pritot*.06)+$pritot,2); ?></div>
        ...
        <div class="row">
         ...
         <div class="row">
            ...
            <?php
		          ...
		          ?>   
            <div class="col-lg-6"><?php echo $prod_auto['nombre']; ?></div>
            <div class="col-lg-1"></div>
            <div class="col-lg-2"><?php echo 'Hasta $USD '.number_format($prod_auto['monto']); ?></div>
