...
if($s_distrito=='LA PAZ'){
    $llave_dosificacion = '7ikhtP587RA7(LDqg\4zpWDRYTFq)\@\P)g+VMF8[(MDd%RB@[BSZcHPNHTJtyNk';
    $numero_autorizacion = '428401900025293';
}elseif($s_distrito=='COCHABAMBA'){
    $llave_dosificacion = 'Z3LPP+ewq+YeWXNLAVW]2cWZ*CS46-tAuKXE5TISEHb=4%KGNMYBmHTC2Vx$$rU_';
    $numero_autorizacion = '428401900026565';
}elseif($s_distrito=='SANTA CRUZ'){
    $llave_dosificacion = 'WsE7\YLM@GrgyEU(q=37CiwTJC5b@aJr+z#=JESGSBX$6DLujJ4A9RfQLCB23hQK';
    $numero_autorizacion = '428401900026577';
}
////nuevoooooo/////////
...
$fecha = date("Y-m-d");
$fecha_control = date("Ymd", strtotime($fecha));
$s_distrito = $_SESSION["distrito"];
$num_fac = $con ->query("SELECT MAX(idnum) as idfactura FROM libro_ventas WHERE distrito='$s_distrito' and autorizacion='$numero_autorizacion'");
		          $numfac = $num_fac -> fetch_assoc();
                  $idfac= $numfac['idfactura']+1;


$pagador = $_POST['pagador'];
//$nitf_cif = $_POST['nitf_cif'];
$monto = $_POST['monto']*6.96;
$monto_qr = number_format($monto,2);
//$num_factura = $_POST['num_factura'];
$cod_cliente = $_POST['cod_cliente'];
$num_poliza = $_POST['num_poliza'];
$nit_unibienes = '338090023';
//$autorizacion = '428101800004352';
$concepto = $_POST['concepto'];
$estado= 'V';
$newDate = date("d/m/Y", strtotime($fecha));
$imp_fiscal = $monto*.13;
$monto_compra_redondo = round($monto);
$hoy = date("Y-m-d");
...
<table cellspacing="0" style="width: 100%;">
    ...
    <tr>
           <td style="width: 30%; color: #444444; font-size:11px;">
			...
			<td style="width: 40%; color: #34495e;font-size:28px; text-align:center;">
                <strong>FACTURA</strong>
            </td>
			<td style="width: 30%;text-align:left; font-size:11px;">
            <div class="caja" style="padding:5px;">
                <p class="salto">NIT: <strong><?php echo $nit_unibienes; ?></strong></p>
                <p class="salto">FACTURA Nº<strong> <?php echo '   '.$idfac;?></strong></p>
                <p class="salto">Nº de Autorización: <strong><?php echo $numero_autorizacion; ?></strong></p>
            </div>
            </td>
    </tr>
    <?php }
    elseif($s_distrito=='COCHABAMBA'){
           ...
           <td style="width: 30%; color: #444444; font-size:11px;">
			...
			<td style="width: 40%; color: #444444; font-size:11px;">
                <br>
                <div style="text-align:center;"><strong style="color: #34495e;font-size:28px;">FACTURA</strong></div>
                <br>SUCURSAL - 1 COCHABAMBA<br>
                Av Pando # 1140<br> 
                Zona: Queru Queru<br>
				Telf.: (591-4) 44129932 - 44129929<br>
				Email: unibienes@unibienes.com.bo<br>
                Cochabamba - Bolivia
            </td>
			<td style="width: 30%;text-align:left; font-size:11px;">
    ...
    elseif($s_distrito=='SANTA CRUZ'){
           ...
           <td style="width: 30%; color: #444444; font-size:11px;">
			...
			<td style="width: 40%; color: #444444; font-size:11px;">
                <br>
                <div style="text-align:center;"><strong style="color: #34495e;font-size:28px;">FACTURA</strong></div>
                <br>SUCURSAL - 2 SANTA CRUZ<br>
                C. Guemes, Edif. “The Loft Mz Of. 101 # 6 <br> 
                Barrio: Equipetrol<br>
				Telf.: (591-3) 3114385 - 3114403<br>
				Email: unibienes@unibienes.com.bo<br>
                Santa Cruz - Bolivia
            </td>
			<td style="width: 30%;text-align:left; font-size:11px;">
    ...
    <table cellspacing="0" style="width: 100%;">
        ...
        <tr>
            <td style="width: 40%;"></td>
            <td style="width: 35%; "></td>
            <td style="text-align: center; font-size:8.5px;">Planes de seguros generales y reaseguros</td>
        </tr>
    </table>
    ...
    <div class="caja" style="border-style: solid; margin:auto; width: 675px; height: 570px;">
...
?>  
    <div>
            <div style="text-align:left; width:79.7%; border:solid 1px; font-size:11px; display:inline;">Son:. <?php echo $cambio.' Bolivianos.'; ?></div>
            <div style="text-align: right; width:10%; border:solid 1px; font-size:12px; display:inline;">TOTAL BS:</div>
            <div style="text-align: right; width:10%; border:solid 1px; font-size:12px; display:inline;"><?php echo number_format($monto,2); ?></div>
            </div>
<div class="container">
        <?php
            ...
            echo $numero_autorizacion."<br>";
            echo $idfac."<br>";
            echo $nitf_cif."<br>";
            echo $fecha_control."<br>";
            echo $monto_compra_redondo."<br>";
            echo $llave_dosificacion."<br>";
            
        $codigo_control = CodigoControlV7::generar($numero_autorizacion, $idfac, $nitf_cif, $fecha_control, $monto_compra_redondo, $llave_dosificacion);
            
        $contenido = $nitf_cif."|".$monto_qr."|".$idfac."|".$numero_autorizacion."|".$fecha_control."|".$codigo_control."|"; //Texto

            //Enviamos los parametros a la Función para generar código QR 
            QRcode::png($contenido, $filename, $level, $tamaño, $framSize); 
    
      $insertar = $con -> query("INSERT INTO `libro_ventas`(`id_lv`, `fecha_factura`, `fecha`, `num_factura`, `idnum`, `autorizacion`, `estado`, `ci_nit`, `nombre_razon`, `importe_venta`, `importe_tasas`, `exp_oper_ext`, `ventas_grav`, `sub_total`, `desc_bon`, `imp_deb_fiscal`, `debito_fiscal`, `codigo_control`, `concepto`, `num_poliza`, `cod_cliente`, `f_registro`, `distrito`) VALUES ('','$fecha','$newDate','$idfac','$idfac','$numero_autorizacion','$estado','$nitf_cif','$pagador','$monto','0','0','0','$monto','0','$monto','$imp_fiscal','$codigo_control','$concepto','$num_poliza','$cod_cliente','$hoy','$s_distrito')");    
        ?>
        ...
        <table cellpadding="0" cellspacing="0">
			...
			<tr style="font-size:10px;">
                ...
                <?php
                //la paz
                if($numero_autorizacion=='428401900025293')
                {
                    ?>
                    <td>Fecha limite de emisión: 28/08/2019</td>
                    <?php
                //la paz
                }elseif($numero_autorizacion=='428401800014765')
                {
                    ?>
                ...
                {
                    ?>
                    <td>Fecha limite de emisión: 23/09/2019</td>
                    <?php
                }elseif($s_distrito=='SANTA CRUZ')
                {
                    ?>
            ...
            <tr width='80%' style="font-size:9px;">
				<td> “ESTA FACTURA CONTRIBUYE AL DESARROLLO DEL PAÍS. EL USO ILÍCITO DE ÉSTA SERÁ SANCIONADO DE ACUERDO A LEY”<br>
                    Ley No 453: Los servicios deben suministrarse en condiciones de inocuidad, calidad y seguridad.
                </td>
			</tr>
		</table>
     </div>     
