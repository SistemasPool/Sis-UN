			...
			<form class="form-horizontal" action="reporte.php" method="post">
                ...
                <div class="col-md-4">
				  <label for="nombre_cliente" class="control-label">Nombre a Facturar</label>
					  <input type="text" class="form-control input-sm" id="pagador" name="pagador" value="<?php echo $pagador; ?>">
				  </div>
                    <div class="col-md-4">
				  <label for="tel1" class="control-label">NIT/CI</label>
				  <input type="text" class="form-control input-sm" id="nitf_cif" name="nitf_cif" value="<?php echo $nitf_cif; ?>">
							</div>
                    <div class="col-md-4">
					<label for="mail" class="control-label">Monto</label>
				      <input type="text" class="form-control input-sm" id="monto" name="monto" value="<?php echo $monto; ?>" readonly>
							</div>
				 </div>
                            <div class="form-group row">
                            <div class="col-md-4">
							<label for="tel2" class="control-label">Fecha</label>
								<input type="text" class="form-control input-sm" id="fecha" name="fecha" value="<?php date_default_timezone_set("America/La_Paz"); echo date("Y-m-d");?>" readonly>
							</div>
                            <div class="col-md-4">
