  ...
  <div class="modal-dialog" role="document">
    ...
    <!-- final modal cuota inicial-->
        ...
        <tbody>
            ...
            { ?>
		 <tr>
            <td><?php echo 'USD $'.$cuotass['monto']; ?></td>
            <td><?php echo $cuotass['fecha_cuotas'];?></td>
		 	<td><?php echo $cuotass['estado']; ?></td>
