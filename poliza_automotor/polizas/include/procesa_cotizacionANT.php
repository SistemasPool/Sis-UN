...
$prima_total = $valor_por_auto*$tasa_prima/100;
...
$inserta = $con -> query("INSERT INTO automovil_cotizacion (id_automovil, cod_cliente, cod_cotizacion, nro_poliza, certificado, id_ce, clase, placa, ano, marca,color, modelo, traccion, uso, distrito, plazas, chasis, motor, auto_cap_aseg, plan, intermediario, tasa_prima, prima_total, prima_credito, plaza) VALUES ('', '$cod_cliente', '$cod_cotizacion', '', '$certificado', '$id_ce', '$clase', '$placa', '$ano', '$marca','', '$modelo', '', '', '$s_distrito', '$pasajeros', '', '', '$valor_por_auto', '$producto_auto', '$intermediario', '$tasa_prima', '$prima_total', '$prima_credito','$plaza')");
