                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cod_cliente" name="cod_cliente" placeholder="Código del Cliente">
                                  </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Número de Póliza</label>
                                <input type="text" class="form-control" id="nro_poliza" name="nro_poliza" placeholder="Número de Póliza">
                              </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
