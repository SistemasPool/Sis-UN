    ...
    <div class="container">
      <div class="starter-template">
        <br><br>
          ...
          $insertar = $con -> query
              ("INSERT INTO cob_adic_au_pol(nombre_cob_au, valor_aseg_au, fran_au, coaseg_au, nro_poliza_auto, codigo_cliente) 
              SELECT cob_adic_au.nombre_cob_au, cob_adic_au.valor_aseg_au, cob_adic_au.fran_au, cob_adic_au.coaseg_au, '$autonumerico', '$cod_cliente' FROM cob_adic_au");
          ?>
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-5"></div>
                <div class="col-md-1">
                 <!-- <a href="coberturas_especificas/index.php?cod_cliente=<?php //echo $fila['cod_cliente']?>&num_poliza=<?php //echo $autonumerico?>">
                <button style="background:#FFF100;" class="btn  btn-xs" type="submit">Ver Coberturas</button></a> -->
                </div>
            </div>
         </div>
         <div class="row">
            ...
            <div class="col-lg-2">
             ...
             <?php
		          ...
		          $sel2 = $con ->query("SELECT * FROM cob_adic_au_pol WHERE codigo_cliente='$codigo' and nro_poliza_auto='$autonumerico'");
            ...
            <div class="col-lg-2">
            <a href="coberturas_especificas/include/actualizar.php?id=<?php echo $cob_au['id_cob_ad_au'] ?>"><button style="background:#0078C1; color:white;" class="btn btn-xs" type="submit">Modificar</button></a>
            <a href="coberturas_especificas/include/borrar.php?id=<?php echo $cob_au['id_cob_ad_au'] ?>&codigo=<?php echo $cob_au['codigo_cliente'] ?>"><button style="background:#F7971C; color:white;" class="btn btn-xs" type="submit">Eliminar</button></a></div>
                 <?php } ?>
            </div>
        </div>
    </div>
