...
if($tipo_pago=='CREDITO'){
    ...
    $i_vigencia = $_POST['i_vigencia'];
    $f_vigencia = date("Y-m-d",strtotime($i_vigencia."+ 1 year"));
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="i_vigencia" name="i_vigencia" placeholder="0000-00-00" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Fecha de Emisión</label>
                                <input type="text" class="form-control" id="f_emision" name="f_emision" placeholder="0000-00-00" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                             ...
                             <div class="col-md-1">
                                ...
                                <select type="text" class="form-control" id="terremoto" name="terremoto" onChange="CambiarFormulario()" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Monto Terremoto</label>
                                <input type="text" class="form-control" id="m_terremoto" name="m_terremoto" disabled>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Terrorismo</label>
                                <select type="text" class="form-control" id="terrorismo" name="terrorismo" onChange="CambiarFormulario1()">
                                <option value='NO'>NO</option>
                                <option value='SI'>SI</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Monto Terrorismo</label>
                                <input type="text" class="form-control" id="m_terrorismo" name="m_terrorismo" disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
...
function CambiarFormulario(){
	switch(document.forms[0].terremoto.selectedIndex){
		case 0: 
			document.forms[0].m_terremoto.disabled=true;
			break;
		case 1: 
			document.forms[0].m_terremoto.disabled=false;
			break;
	}
}

    
function CambiarFormulario1(){
	switch(document.forms[0].terrorismo.selectedIndex){
		case 0: 
			document.forms[0].m_terrorismo.disabled=true;
			break;
		case 1: 
			document.forms[0].m_terrorismo.disabled=false;
			break;
	}
}
