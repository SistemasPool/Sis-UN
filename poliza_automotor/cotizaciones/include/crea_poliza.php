                         ...
                         <!--   <div class="col-md-4">
                           ...
                           <!-- <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="comision_intermediario" name="comision_intermediario" value="0">
                              </div>
                            </div>
                            </div>
                            </div>
         ...
         ?>
                ...
                $incarro = $con -> query("SELECT * FROM automovil_cotizacion WHERE cod_cotizacion='$cod_cotizacion'");
                    ...
                    while ($row = $incarro -> fetch_assoc()) {
                            $setenta_credito = $row['prima_credito'];
                        //echo   $setenta_credi = $row['prima_credito']+$setenta_credito;
                            $setenta = $setenta_credito*.70/4;
                            ?>
                            <div class="col-md-3">
                                <div class="form-group">
