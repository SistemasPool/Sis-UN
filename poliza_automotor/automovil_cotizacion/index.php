  ...
  <body style="padding:50px;">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="../../poliza_automotor/cotizaciones/index.php">Ver Cotizaciones</a></li>
          <li><a href="../../poliza_automotor/polizas/include/cotizacion_automotor.php">Automotores</a></li>
        </ul>
      </li>
          </ul>
        </div><!--/.nav-collapse -->
