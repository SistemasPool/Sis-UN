  ...
  <body style="padding:50px;">
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <thead>
            <tr>
                ...
                <th>Celular</th>
                <th></th> 
                <th><button class="btn btn-primary btn-xs" type="submit" data-toggle="modal" data-target="#myModal">Guardar</button></th>
            </tr>
        </thead>
        <tfoot>
            <tr>
      ...
      <td><?php echo $fila['celular'] ?></td>
		 	<td>
                <a href="include/actualizar.php?id=<?php echo $fila['id_cliente'] ?>"><button class="btn btn-warning btn-xs" type="submit" >Editar</button></a>
                <a href="include/borrar.php?id=<?php echo $fila['id_cliente'] ?>"><button class="btn btn-danger btn-xs" type="submit">Eliminar</button></a></td>
                <td><select name="forma" onchange="location = this.value;">
                 <option>Póliza a Generar</option>
                 <option value="../poliza_automotor/automotor_individual.php?id=<?php echo $fila['id_cliente'] ?>"">Automotor</option>
