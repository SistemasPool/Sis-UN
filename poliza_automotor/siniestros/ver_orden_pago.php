    ...
    <div class="container-fluid">
      ...
      <div class="starter-template">
        ...
        <tbody>
                  ...
                  <?php
		          $sel = $con ->query("SELECT * FROM orden_pago");
		          while ($fila = $sel -> fetch_assoc()) {
		          ?>
		 <tr>
		 	<td><?php echo $num_orden = $fila['num_orden'] ?></td>
            <td><?php echo $num_siniestro = $fila['num_siniestro'] ?></td>
		 	<td><?php echo $poliza = $fila['num_poliza'] ?></td>
		 	<td><?php echo $cliente = $fila['num_cliente'] ?></td>
            <td><?php echo $fila['asegurado'] ?></td>
            <td><?php echo $fila['cobertura_afectada'] ?></td>
            <td><?php echo $fila['importe_bs'] ?></td>
            <td><?php echo $fila['importe_dls'] ?></td>
             
        <?php 
        if($usuario=='Auditoria'){
            ?>
             <td>
             <a href="../pdf/pdf_orden_pago.php?num_orden=<?php echo $num_orden; ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-file-pdf"></i></button></a></td>
            <?php
        }else{?>
         <td>
                ...
                <a href="../pdf/pdf_orden_pago.php?num_orden=<?php echo $num_orden; ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-file-pdf"></i></button></a>
                <a href="include/liquidacion_auto.php?num_orden=<?php echo $num_orden; ?>&num_siniestro=<?php echo $num_siniestro; ?>"><button class="btn btn-default btn-xs" type="submit"><i class="fas fa-file-pdf"></i></button></a>
                </td>
            <?php } ?>
		 </tr>
                  <?php } ?>
