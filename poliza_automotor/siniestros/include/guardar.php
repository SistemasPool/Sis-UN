...
//{
  ...
  $ins_datos = $con -> query("INSERT INTO `datos_act_sin`(`id_datos_act_sin`, `num_siniestro`, `estado`, `monto_reserva`, `fecha_registro`) VALUES ('', '$num_siniestro', 'PENDIENTE', '$reserva', '$fecha_de_registro')");
    ...
    //ok
    $ins_dan_per = $con -> query("INSERT INTO `danos_persona`(`id_danos_personas`, `tipo_persona`, `nombre_persona`, `edad_persona`, `direccion_persona`, `telefono_persona`, `celular`, `email`, `comentario_lesiones_persona`, `comentario_adicional_persona`, `fecha_registro`, `num_poliza`, `cod_cliente`, `num_siniestro`) VALUES ('', '$tipo_persona', '$nombre_per', '$edad_per', '$direccion_per', '$telefono_per', '$celular_per', '$email_per', '$com_lesiones', '$com_adicional', $fecha_de_registro, '$num_poliza', '$cod_cliente', '$num_siniestro')");
    ...
    if($num_poliza=='AULP00000033'){
    $prestatario = $_POST['prestatario'];
        
        $ins_sin = $con -> query("INSERT INTO `siniestros`(`id_siniestro`, `id_sin`, `num_siniestro`, `asegurado`, `direccion`, `telefono_fijo`, `email`,`fecha_denuncia`, `fecha_siniestro`, `num_poliza`, `cod_cliente`, `cobertura_aplicar`, `monto_reserva`, `placa_sin`, `marca`, `uso`, `clase`, `detalle_sin`, `estado`, `fecha_respuesta`, `fran_coaseg_sin`, `monto_reclamado`, `monto_pagado`, `observaciones`, `fecha_registro`, `inicio_vigencia`, `final_vigencia`, `insperctor`) VALUES ('', $ids, '$num_siniestro', '$prestatario', '$direccion', '$telefono_fijo', '$email', '$f_denuncia', '$f_siniestro', '$num_poliza', '$cod_cliente', '$cobertura_aplicar', '$reserva','$placa', '$marca', '$uso', '$clase', '', 'PENDIENTE', '', '', '', '', '', '$fecha_de_registro', '$inicio_vigencia', '$final_vigencia', '$inspector')");
    }else{
    
    //ok
    $ins_sin = $con -> query("INSERT INTO `siniestros`(`id_siniestro`, `id_sin`, `num_siniestro`, `asegurado`, `direccion`, `telefono_fijo`, `email`,`fecha_denuncia`, `fecha_siniestro`, `num_poliza`, `cod_cliente`, `cobertura_aplicar`, `monto_reserva`, `placa_sin`, `marca`, `uso`, `clase`, `detalle_sin`, `estado`, `fecha_respuesta`, `fran_coaseg_sin`, `monto_reclamado`, `monto_pagado`, `observaciones`, `fecha_registro`, `inicio_vigencia`, `final_vigencia`, `insperctor`) VALUES ('', $ids, '$num_siniestro', '$completo', '$direccion', '$telefono_fijo', '$email', '$f_denuncia', '$f_siniestro', '$num_poliza', '$cod_cliente', '$cobertura_aplicar', '$reserva','$placa', '$marca', '$uso', '$clase', '', 'PENDIENTE', '', '', '', '', '', '$fecha_de_registro', '$inicio_vigencia', '$final_vigencia', '$inspector')");
    }
