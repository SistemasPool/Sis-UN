    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <tbody>
                  ...
                  <?php
		          $sel = $con ->query("SELECT * FROM liquidacion_auto");
		          while ($fila = $sel -> fetch_assoc()) {
		          ?>
		 <tr>
            <td><?php echo $num_orden = $fila['num_liquidacion'] ?></td>
		 	<td><?php echo $num_orden = $fila['num_orden'] ?></td>
            <td><?php echo $num_siniestro = $fila['num_siniestro'] ?></td>
            <td><?php echo $fila['num_tran'] ?></td>
		 	<td><?php echo $fila['num_cheque'] ?></td>
             <td><?php echo $fila['girado'] ?></td>
         ...
         <td>
                ...
                <a href="../pdf/pdf_liquidacion.php?num_orden=<?php echo $num_orden; ?>&num_siniestro=<?php echo $num_siniestro; ?>"><button class="btn btn-default btn-xs" type="submit"><i class="fas fa-file-pdf"></i></button></a>
                </td>
		 </tr>
                  <?php } ?>
        </tbody>
