...
$sel = $con -> query("SELECT * FROM producto_automotores_pol WHERE id_prod_auto='$id' ");
$fila = $sel -> fetch_assoc();
$producto_auto = $fila['producto_auto'];
 ?>
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
          <div class="panel-heading">
            <h6 class="card-subtitle mb-2 text-muted">.:: EDITAR PRODUCTO ::.</h6>
          </div>
          <div class="panel-body">
            <form action="update.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?php echo $id ?>">
                <input type="hidden" name="cod_cliente" value="<?php echo $fila['cod_cliente']; ?>">
                <input type="hidden" name="nro_poliza" value="<?php echo $fila['nro_poliza']; ?>">
                    ...
                    <div class="container">
                        ...
                        <div class="col-md-12">
                                  ...
                                  <select class="form-control" id="producto_auto" name="producto_auto">
                                        ...
                                        <?php
                                          ...
                                          while ($prod_auto = mysqli_fetch_array($que)) {
                                            echo '<option selected="'.$producto_auto.'">'.$prod_auto['producto_auto'].'</option>';
                                          }
                                        ?>
                                      </select>
                              </div>
                            ...
                            <div class="col-md-4"><br>
                                  <button type="submit" class="btn btn-success btn-sm">Actualizar</button></div>
                            </div>
                        </div>
                        </div>
                    </form>
