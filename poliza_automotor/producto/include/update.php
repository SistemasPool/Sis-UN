...
$up = $con -> query("UPDATE producto_automotores_pol SET producto_auto='$producto_auto', monto='$monto' WHERE cod_cotizacion='$cod_cotizacion'");
$upd = $con -> query("UPDATE automovil_cotizacion SET plan='$producto_auto' WHERE cod_cotizacion='$cod_cotizacion'");
