		 ...
		 <tr>
            ...
            <td><?php echo $fila['distrito']; ?></td>
		 	<td>
                ...
                <a href="include/poliza_incendio.php?num_poliza=<?php echo $fila['num_poliza']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a>
