...
$sel = $con -> query("SELECT * FROM clau_adic_incendio_pol WHERE id_cai='$id' ");
...
<nav class="navbar navbar navbar-default navbar-static-top marginBottom-0" role="navigation">
    ...
    <div class="container">
        <h2>Editar Primer Riesgo de Incendio</h2>
        <br>
      <form action="update.php" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="glosa" name="glosa"><?php echo $fila['glosa'];?></textarea>
                              </div>
                            </div>
