...
$ins = $con -> query("INSERT INTO `clau_adic_incendio_pol`(`id_cai`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$clau','INCENDIO','$cod_cliente','','$cod_cotizacion')");
