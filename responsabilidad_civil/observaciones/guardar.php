...
$ins = $con -> query("INSERT INTO `observaciones_incendio_pol`(`id_oi`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$clau','INCENDIO','$cod_cliente','','$cod_cotizacion')");
