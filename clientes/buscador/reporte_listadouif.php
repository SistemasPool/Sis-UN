...
<br><br>
    <div class="container">
     <form method="post" action="excel_loguif.php">
  <div class="form-row">
    ...
    <div class="col-md-3">
                            ...
                            <select class="form-control" id="cliente" name="cliente">
                             <option></option>
                            <?php
                              $query = $con ->query("SELECT DISTINCT(cliente) FROM log_uif");
                              //mysqli_set_charset('utf8');
                              while ($log_uif = mysqli_fetch_array($query)) {
                                  ?>
                              <option value="<?php echo $log_uif['cliente']; ?>"><?php echo $log_uif['cliente']; ?></option>
                                <?php
                              }
                            ?>
                          </select>
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="f_inicial" name="f_inicial">
    </div>
      
      <div class="form-group col-md-3">
       <label for="inputZip">Fecha Final</label>
      <input type="text" class="form-control" id="f_final" name="f_final">
    </div>
  </div>
