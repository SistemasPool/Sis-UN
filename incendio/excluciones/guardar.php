...
$ins = $con -> query("INSERT INTO `exclusiones_incendio_pol`(`id_exi`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$glosa','INCENDIO','$cod_cliente','','$cod_cotizacion')");
