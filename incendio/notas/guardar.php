...
$ins = $con -> query("INSERT INTO `notas_especiales_incendio_pol`(`id_nei`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$glosa','INCENDIO','$cod_cliente','','$cod_cotizacion')");
