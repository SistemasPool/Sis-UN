...
$ins = $con -> query("INSERT INTO `nota_especial_incendio_pol`(`id_ne`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$glosa','INCENDIO','$cod_cliente','','$cod_cotizacion')");
