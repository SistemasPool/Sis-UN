...
$primer_r = $_POST['primer_r'];


$ins = $con -> query("INSERT INTO `primer_riesgo_pol`(`id_pr`, `glosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$primer_r','INCENDIO','$cod_cliente','','$cod_cotizacion')");
