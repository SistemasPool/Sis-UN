...
$sel = $con -> query("SELECT * FROM franquicia_incendio_pol WHERE id_fi='$id' ");
      ...
      <form action="update.php" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="glosa" name="glosa"><?php echo $fila['grosa'];?></textarea>
                              </div>
                            </div>
