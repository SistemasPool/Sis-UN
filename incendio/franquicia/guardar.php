...
$ins = $con -> query("INSERT INTO `franquicia_incendio_pol`(`id_fi`, `grosa`, `ramo`, `cod_cliente`, `num_poliza`, `cod_cotizacion`) VALUES ('','$clau','INCENDIO','$cod_cliente','','$cod_cotizacion')");
