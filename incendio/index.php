    ...
    <div class="container-fluid">
      <div class="starter-template">
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT DISTINCT `id_incendio`, `cod_cliente`, `cod_cotizacion`, `num_poliza`, `id_num`, `ubicacion_riesgo`, `direccion_asegurada`, `materia_seguro`, `valor_asegurado`, `tasa_prima`, `prima_contado`, `prima_credito`, `inicio_vigencia`, `final_vigencia`, `f_registro`, `distrito`, `tipo_pago` FROM incendio_cotizacion WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['cod_cliente'];?></td>
		 	...
		 	<td><?php echo $fila['valor_asegurado']; ?></td>
		 	<td><?php echo $fila['ubicacion_riesgo']; ?></td>
            <td><?php echo $fila['direccion_asegurada']; ?></td>
            <td><?php echo $fila['prima_contado']; ?></td>
            <td><?php echo $fila['distrito']; ?></td>
		 	<td>
                ...
                <a href="include/verpolizaincendio.php?cod_cotizacion=<?php echo $fila['cod_cotizacion']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a>
                
                <a href="include/crea_pol_inc.php?cod_cotizacion=<?php echo $fila['cod_cotizacion']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>&tipo_pago=<?php echo $fila['tipo_pago']; ?>"><button class="btn btn-default btn-xs" type="submit"><i class="fas fa-cogs"></i></button></a>
                </td>
		 </tr>
                  <?php } ?>
        </tbody>
