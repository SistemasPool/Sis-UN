...
<table width=90% align=center cellspacing=0 cellpadding=0>
    <tr><td style="font-size:12px; text-align:center;">P&Oacute;LIZA DE SEGURO DE INCENDIO</td></tr>
    <tr><td style="font-size:10px; font-weight:bold; text-align:center;">CONDICIONES PARTICULARES</td></tr>
</table>
<br><br>
<table width=90% align=center cellspacing=0 cellpadding=0>
    <tr><td style="font-size:10px; font-weight:bold; text-align:center;">C&Oacute;DIGO: 116-9101139-2018 01 001 1001</td></tr>
    <tr><td style="font-size:10px; font-weight:bold; text-align:center;">Aprobado por Resoluci&oacute;n Administrativa APS/DS/No 165/2018 del 7 de Febrero de 2018</td></tr>
</table>
<br><br><br>
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
<tr><td>N&uacute;mero de P&oacute;liza: <?php echo $codigo; ?></td>
</tr>
</table>
<?php
...
<?php
$incendio = $con ->query("SELECT * FROM `pol_incendio` WHERE nro_poliza='$codigo'");
...
<tr>
 ...
 <tr>
    ...
    <td width=70%><?php echo strtoupper($ince['ubicacion']); ?></td>
</tr>
<tr>
    <td width=30%>Direcci&oacute;n Asegurada:</td>
    <td width=70%><?php echo strtoupper($ince['direccion_aseg']); ?></td>
</tr>
<tr>
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    <tr>
        ...
        <?php
        $cober = $con ->query("SELECT * FROM coberturas_incendio_pol WHERE num_poliza='$codigo'");
        while($cobe = $cober -> fetch_assoc()){
        $glosa = $cobe['glosa'];
        ?>  
        <tr>
        <td style="text-align: justify;" width=95%><?php echo strtoupper($glosa); ?></td>
        <td width=5%></td>
        </tr>
            <?php } ?>
</table>
<?php
    $riesgo = $con ->query("SELECT * FROM primer_riesgo_pol  WHERE num_poliza='$codigo'");
    ?>
<br>
<hr width=90%>
<br>
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    ?>   
        <tr>
        <td style="text-align: justify;" width=95%><?php echo "* ".strtoupper($ri['glosa']); ?></td>
        <td width=5%></td>
        </tr>
    <?php } ?>
</table>
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    ?>   
        <tr>
        <td width=95%><?php echo "* ".strtoupper($ac['glosa']);?></td>
        <td width=5%></td>
        </tr>
    <?php } ?>
</table>
...
<br>
<?php
    $clausula = $con ->query("SELECT * FROM `franquicia_incendio_pol` WHERE num_poliza='$codigo'");
    ?>
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    <tr>
    ...
    ?>   
        <tr>
        <td style="text-align: justify;" width=95%><?php echo "* ".strtoupper($cla['grosa']);?></td>
        <td width=5%></td>
        </tr>
    <?php } ?>
</table>
...
<br>
<?php
    $beneficios = $con ->query("SELECT * FROM `exclusiones_incendio_pol` WHERE num_poliza='$codigo'");
    ?>
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    <tr>
    ...
    ?>   
        <tr>
        <td align="justify" width=95%><?php echo "* ".strtoupper($bene['glosa']);?></td>
        <td width=5%></td>
        </tr>
    <?php } ?>
</table>
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    <?php
		          $sewa = $con ->query("SELECT * FROM `cond_part_inc_pol` WHERE num_poliza='$codigo'");
		          while ($reqaeg = $sewa -> fetch_assoc()) {
     ?>   
    <tr>
        <td width=95%><?php echo "* ".strtoupper($reqaeg['glosa']);?></td>
        <td width=5%></td>
    </tr>
    <?php } ?>
</table> 
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    <?php
		          $nota = $con ->query("SELECT * FROM `notas_especiales_incendio_pol` WHERE num_poliza='$codigo'");
		          while ($notacla = $nota -> fetch_assoc()) {
     ?>   
    <tr>
    <td style="text-align: justify;" width=95%><?php echo "* ".strtoupper($notacla['glosa']);?></td>
    <td width=5%></td>
    </tr>
    <?php } ?>
</table> 
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    <?php
		          $obs = $con ->query("SELECT * FROM `observaciones_incendio_pol` WHERE num_poliza='$codigo'");
		          while ($obse = $obs -> fetch_assoc()) {
     ?>   
    <tr>
    <td style="text-align: justify;" width=95%><?php echo "* ".strtoupper($obse['glosa']);?></td>
    <td width=5%></td>
    </tr>
    <?php } ?>
</table> 
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    <?php
		          $noti = $con ->query("SELECT * FROM `nota_especial_incendio_pol`  WHERE num_poliza='$codigo'");
		          while ($notis = $noti -> fetch_assoc()) {
     ?>   
    <tr>
    <td style="text-align: justify;" width=95%><?php echo "* ".strtoupper($notis['glosa']);?></td>
    <td width=5%></td>
    </tr>
    <?php } ?>
</table> 
...
<br>
<?php
		          $prima = $con ->query("SELECT * FROM `pol_incendio` WHERE nro_poliza='$codigo'");
		          $primas = $prima -> fetch_assoc();
                  $prima_total=$primas['prima_total'];

$tipo_pago = $ince['tipo_pago'];
...
<table width=90% style="font-size:8px;" align="center" cellspacing=0 cellpadding=0>
    ...
    <tr>
        <td width=15%><?php echo $ince['intermediario']; ?></td>
    </tr>
</table>
<!-- 
