...
$fi = $sele -> fetch_assoc();
$sell = $con -> query("SELECT * FROM acc_perso_cotizacion WHERE cod_cotizacion='$cod_cotizacion' ");
            ...
            <input type="hidden" class="form-control" id="cod_cotizacion" name="cod_cotizacion" value="<?php echo $cod_cotizacion; ?>">
                        ...
                        <div class="col-md-12">
                         ...
                         <!--   <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Inicio de Vigencia</label>
                           ...
                           <!-- <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Com. Intermediario</label>
                                <input type="text" class="form-control" id="com_intermediario" name="comision_intermediario" value="<?php echo number_format($fico['com_inter'],2); ?>" readonly>
                              </div>
                            </div>
                            <div class="col-md-6">
                                 <button type="submit" name="Enviar" class="btn btn-primary" value="Enviar">Procesar...</button>
                            </div>
                            </div>
                            </div>
                        </div>
