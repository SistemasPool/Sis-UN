...
$llave_dosificacion = 'RjMmHg#z\BdG(5a[2==WeU4-E5-3#SdQRNAuAYIi[6b%qJBp\yK=rMQn%\wjMm4)';
...
$num_fac = $con ->query("SELECT MAX(idnum) as idfactura FROM libro_ventas WHERE distrito='$s_distrito'");
...
$estado_pago = 'PAGADO';
$id_fa = $_POST['id_factura'];
//////$cod_cliente = $_POST['cod_cliente'];
//////$num_poliza = $_POST['num_poliza'];
//////$tipo_pago = $_POST['tipo_pago'];
//////$nro_factura = $_POST['nro_factura'];

$actualiza_edo_cta = $con -> query("UPDATE calculo_prima SET estado='$estado_pago', nro_factura='$idfac' WHERE id_calculo_prima='$id_fa'");
...
<div class="container">
        ...
        $codigo_control = CodigoControlV7::generar($numero_autorizacion, $idfac, $nitf_cif, $fecha_control, $monto, $llave_dosificacion);
            
        $contenido = $nit_unibienes."|".$monto_compra_redondo."|".$idfac."|".$numero_autorizacion."|".$fecha_control."|".$codigo_control."|"; //Texto
