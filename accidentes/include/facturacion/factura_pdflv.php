...
?>
    ...
    <div>
            <div style="text-align:left; width:69.7%; border:solid 1px; border-color:white; font-size:11px; display:inline;">Son:. <?php echo $cambio.' Bolivianos.'; ?></div>
...
<div class="container">
        ...
        $contenido = $nit."|".$monto_redondo."|".$num_factura."|".$autorizacion."|".$date."|".$codigo_control."|"; //Texto
