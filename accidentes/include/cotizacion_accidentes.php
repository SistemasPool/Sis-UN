...
<nav class="navbar navbar navbar-default navbar-static-top marginBottom-0" role="navigation">
    ...
    <div class="container">
        ...
        <br>
	 <form action="procesa_cot_ap.php" method="post">
                    <div class="container">
                        <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="suma_a" name="suma_a" placeholder="Suma Asegurada" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                <label for="exampleInputPassword1">Prima Total</label>
                                <input type="text" class="form-control" id="prima_total" name="prima_total" placeholder="Prima Total" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
