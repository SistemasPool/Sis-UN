    ...
    <div class="container-fluid">
      <div class="starter-template">
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT * FROM incendio_poliza WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['distrito']; ?></td>
		 	<td>
                ...
                <a href="include/verpolizaincendio.php?num_poliza=<?php echo $fila['num_poliza']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a>
                <!-- <a href="include/procesa_pol_incendio.php?cod_cotizacion=<?php echo $fila['cod_cotizacion']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>&tipo_pago=<?php echo $fila['tipo_pago']; ?>"><button class="btn btn-default btn-xs" type="submit"><i class="fas fa-cogs"></i></button></a> -->
                </td>
		 </tr>
                  <?php } ?>
        </tbody>
