    ...
    <div class="container-fluid">
      <div class="starter-template">
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT * FROM acc_perso_poliza WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['distrito']; ?></td>
		 	<td>
                ...
                <a href="include/poliza_accidentes.php?num_poliza=<?php echo $fila['num_poliza']; ?>&cod_cliente=<?php echo $fila['cod_cliente']; ?>"><button class="btn btn-primary btn-xs" type="submit"><i class="fas fa-eye"></i></button></a>
                
                
                <a href="../accidentes/include/estado_cuenta.php?cod_cliente=<?php echo $fila['cod_cliente'] ?>&nro_poliza=<?php echo $fila['num_poliza'] ?>&tipo_pago=<?php echo $fila['tipo_pago']; ?>"><button class="btn btn-primary btn-xs" type="submit">Estado Cuenta</button></a>
                </td>
		 </tr>
                  <?php } ?>
        </tbody>
