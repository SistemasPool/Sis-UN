    ...
    <div class="container">
      <div class="starter-template">
        ...
        <tbody>
		          ...
		          $sel = $con ->query("SELECT DISTINCT id_cliente, cod_cliente, nombres, paterno, materno, telefono_fijo, celular, distrito FROM clientes WHERE distrito='$s_distrito'");
		 ...
		 <tr>
            ...
            <td><?php echo $fila['distrito']; ?></td>
		 	<td>
                ...
                <a href="include/borrar.php?id=<?php echo $fila['id_cliente'] ?>"><button class="btn btn-danger btn-xs" type="submit"><i class="fas fa-times"></i></button></a></td>
                <td>
                <select name="forma" onchange="location = this.value;">
                <option>Creación de:</option>
                <option value="../poliza_automotor/polizas/include/cotizacion_automotor.php?cod_cliente=<?php echo $fila['cod_cliente']; ?>">Cotización</option>
